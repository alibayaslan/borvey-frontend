...
const ReportModalUser = ({ isOpenReport, setIsOpenReport, id }) => {
  const modalVariants = {
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className="text-[20px]">Kullanıcıyı Bildir</h3>
              <button
            ...
            <div className="flex items-center flex-col my-6">
              <form onSubmit={handleComment}>
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Yükleniyor..." : "Kullanıcıyı Bildir"}
                </button>
                <p
...
export default ReportModalUser;
